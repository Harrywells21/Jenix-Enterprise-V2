...
setsid nohup uvicorn main:app --host 0.0.0.0 --port 8000 > ~/Desktop/jenix/floor1_reportb_restart.log 2>&1 < /dev/null &
disown
sleep 4
...
cat ~/Desktop/jenix/floor1_reportb_restart.log
